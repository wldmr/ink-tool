 ...
 * (lift_up_cup) {not teacup} [Take it] 
   take the mug,} and blow away the steam. It is too hot to drink. 
 ...
 * {teacup} 	[Wait] 		
   ...
   Harris} begins{forceful <= 0:, sternly}. I've seen him adopt this stiff tone of voice before, but only when talking to the brass. "I'm sure you agree."
 * [Agree] 
   "Awkward," I reply
 * (disagree) [Disagree] 
 ...
 * (sore) { forceful >= 0 } "Damn right[."] I'm sore. Was it one of the others who put you up to this? Was it Hooper? He's always been jealous of me. He's..."
  ...
  * * "Of my genius.["] Hooper simply can't stand that I'm cleverer than he is. We work so closely together, cooped up in that Hut all day. It drives him to distraction. To worse."
      ...
      * * * "Quite right[."]," I answer smartly.
            , voice quivering. "For God's sake!"}
 					* * * 	[Lie] -> iamnotraitor
      - - - He stares back at me. 

            I don't like to talk of myself like this, but I carry on all the same.} "Hooper simply can't bear knowing that, once all this is over, I'll be the one receiving the knighthood and he..."
...
=== harris_demands_component ===
                                                                             wasting no time}: Bletchley is his watch. "Do you know where it is?"
                                                                             * [Yes]
                                                                               "I do." 
			...
			-> missing_reel -> 
                                                                             ...
                                                                             * [Co-operate] "I know where it is."
                                                                               -> admitted_to_something
                                                                               ; I'm unaccustomed to facing off against men with holstered guns}. 
        ...
        replies}, placing his own cup back on the table untouched. "Such a curious flavour. It might almost not be tea at all. You might say it hides a multitude of sins. As do you. Isn't that right?"
				...
				"I suppose so," I reply. "I've done things I shouldn't have done." 
				 ...
				 -> harris_presses_for_details
                                                                             ...
                                                                             * { not drugged  }   [Evade] 
                                                                               But I've done nothing to deserve this treatment}. Now, please. Let me go. I'll help you find this damn component, of course I will." 
				//   Who do you blame?
 ...
 * { not drugged  } [Evade] 
   somewhat miserably}. "I'm just waiting until you tell me what is really going on."
				 ~ raise(evasive)
 * { drugged  } [Evade] 				 
 ...
 * [Co-operate]
   my letters. Haven't you? In fact, if you haven't, don't tell me}.
		 ~ admitblackmail  = true
   Harris nods once. 
   <> -> harris_has_seen_it_before
...
= harris_being_convinced
                                                         I can see he's still not certain whether he can trust me.} "Which means the question is, what can we do to rat him out?"
	 * [Offer to help] 
 ...
 * [Work slowly] 
   { smashingWindowItem == SHOE :a shoe|nothing but brute force}}. 
...
= time_to_move_now
 ...
 { smashingWindowItem == SHOE :shoe|fist}} and it shatters with a terrific noise. Then I stop, and wait, to see if anyone will come in through the door.
 Nothing.
 ...
 * [Clear the frame of shards]
 ...
 -	Then the door locks turns. The door opens. Then Jeremy — one of the guards, rather — sticks his head through the door. "I thought I heard..." 
   Sees the broken window.} Then without a moment's further thought he blows his shrill whistles and hustles into the hut, grabbing me roughly by my arms.
   { pause:
...
=== smash_the_window
	//  Smashing glass
                                              { smashingWindowItem == SHOE : my shoe by its toe, |back my arm, }} and take a strong swing, trying to imagine it's Harris' face on the other side.
	 	~ smashedglass  = true
  ...
  * [Escape the compound] 
    ...
    Perhaps not as a traitor — they might take the idea that Hooper was involved with the theft — but certainly as a valuable mind, one containing valuable secrets and all too easily threatened. They will think I am running away because of my indiscretions. I suppose, in fairness, that I am.}
			* * [Go] 			-> live_on_the_run
    * * [Don't go] 
 ...
 * [Disapprove] 
   ...
   Mr Intelligent}. There's a 24—hour—late message to be tackled and we're a genius short. So you'd better be ready to work twice as hard."
 * [Thank him] 	
 ...
 * [Listen at the door] 	
   Perhaps the component has been found and the crisis is over.}
 ...
 * { hooperClueType > NONE  }   	[Wait] 
  ...
  * * [Wait] 
  ...
  - - 	Curiouser and curiouser. I nod once to Harris and slip outside into the cold morning air.
       { hooperClueType == NONE  :
                                                                           — if I successfully implied to him that I had him framed, but he did not unpack my little clue well enough to go looking for the component. Well, I had figured him for a more intelligent opponent, but a resignation from the game will suffice}. Or perhaps he knew he would be followed if he went to check, and decided he would be doomed either way.
				- else:
 ...
 * [Evade]
		...
		"Oh, of course. Worked all night, did you? Well, you'll hear soon enough. Can hardly hide the fact there'll only be three of us from now on."
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            its recovery does mean }I have nothing to sell to save my reputation{ i_met_a_young_man :, if I have any left}. 
 { not framedhooper  :
 ...
 * { not framedhooper  }   [Leave it] 
                                                                                                                                                                                              understood} my clue, he will have explained it to them to save his neck. They won't believe him — but they won't quite disbelieve him either. We're locked in a cycle now, him and me, of half—truth and probability. There's nothing either of us can do to put the other entirely into blame.
...
=== go_to_where_component_is_hidden
	 ...
	 * 	[Evade] 
			...
			I almost wish I had a way to make the hut explode, but of course I don't.
                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                  you told Hooper where to look with your little riddle}."
...
=== reveal_location_of_component
                                                                                                                                                                                                                      dispose of it} once the fuss had died down. I suppose I was foolish to think that it might."
	~ piecereturned  = true
	-> harris_believes	
= harris_believes
   ...
   But I cannot, not even here, in our little haven from the horrors of the war.
	...
	-	(monastic) A monastic life, with plenty of problems to keep me going. 
		I wonder what else I might yet unravel before I'm done?
                                                                                                                We are just pieces in this machine; interchangeable and prone to wear.}
	- 	That is the true secret of the calculating engine, and the source of its power. It is not the components that matter, they are quite repetitive. What matters is how they are wired; the diversity of the patterns and structures they can form. Much like people — it is how they connect that determines our victories and tragedies, and not their genius.
                                                            the young man who put me in this spot} to them as well as myself?
		 * 	[Yes] 
                                          A little vengeance, disguised as doing something good.}
		 * 	[No] 
